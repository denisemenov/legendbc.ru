<!-- components/content/Grid.vue -->
<template>
  <div class="grid gap-4" :class="gridClasses">
    <!-- 
      ContentSlot означает, что всё, что будет вложено в Grid,
      окажется внутри этого блока (колонки, текст и т.п.).
      'unwrap="p"' убирает лишние <p> вокруг слотов при вставке Markdown-текста. 
    -->
...
// Маппинги: количество колонок -> соответствующий класс Tailwind
const GRID_CLASSES = {
  1: 'grid-cols-1',
  2: 'grid-cols-2',
  3: 'grid-cols-3',
...
// Считаем все классы на основе пропсов
