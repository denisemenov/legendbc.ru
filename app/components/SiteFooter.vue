<template>
  <footer id="contacts" class="flex flex-col md:flex-row gap-4">
    <div class="w-full md:w-1/2">
      <ClientOnly>
        <div id="yamap" ref="mapContainer" class="w-full min-h-[400px] sm:min-h-[600px] relative"/>
      </ClientOnly>
    </div>
    ...
    <div
      ...
      <div class="space-y-4">
        ...
        <p>
          ...
          <NuxtLinkLocale to="tel:+79166244545">
            +7 916 624 4545
          </NuxtLinkLocale>
        ...
        <div class="space-y-1">
          ...
          <NuxtLinkLocale v-for="link in socials" :key="link.name" :to="link.url" class="block">
            {{ link.name }}
          </NuxtLinkLocale>
        </div>
      </div>
