...
(function () {
  ...
  window.tram = (function (a) {
    ...
    function i(a, b, c) {
      ...
      var d = c;
      return (
        $.test(a) || !_.test(a) ? (d = parseInt(a, 10)) : _.test(a) && (d = 1e3 * parseFloat(a)),
        0 > d && (d = 0),
        d === d ? d : c
      );
    }
    ...
    var J = (b.frame = (function () {
      ...
      L = l(function (b) {
          ...
          if (a) {
            ...
            if ('object' == e) {
              ...
              u.call(
                ...
                t.call(this),
                f > 0 &&
                  ((this.timer = new S({ duration: f, context: this })),
                  (this.active = !0),
        ...
        function f(a) {
          (a = i(a, 0)),
            this.active
              ...
              : ((this.timer = new S({ duration: a, context: this, complete: h })), (this.active = !0));
        }
        function g(a) {
          return this.active
            ? (this.queue.push({ options: a, args: arguments }), void (this.timer.complete = h))
        ...
        function l(a) {
          ...
          var b;
          'string' == typeof a ? ((b = {}), (b[a] = 1)) : (b = 'object' == typeof a && null != a ? a : this.props),
            u.call(this, b, v),
            t.call(this);
        }
        function m(a) {
      ...
      N = l(function (a) {
        ...
        (a.init = function (a, b, d, e) {
          ...
          (a.fallback = function (a) {
            ...
            (a = this.convert(a, this.type)),
              this.auto &&
                ('auto' == c && (c = this.convert(this.get(), this.type)), 'auto' == a && (a = b.call(this))),
              (this.tween = new R({
                from: c,
                to: a,
              ...
              c.call(this, a, function (a, c, e) {
                (d[a] = c),
                  void 0 === this.current[a] &&
                    ((b = 0), ~a.indexOf('scale') && (b = 1), (this.current[a] = this.convert(b, e)));
              }),
              d
            );
          });
  ...
  var require$$1 =
    underscoreCustom && typeof underscoreCustom === 'object' && 'default' in underscoreCustom
      ? underscoreCustom['default']
      : underscoreCustom;
  ...
  var require$$0 =
    webflowLib && typeof webflowLib === 'object' && 'default' in webflowLib ? webflowLib['default'] : webflowLib;
  ...
  var require$$0$2 =
    webflowIxEvents && typeof webflowIxEvents === 'object' && 'default' in webflowIxEvents
      ? webflowIxEvents['default']
      : webflowIxEvents;
      ...
      (module.exports = function ($, _) {
        ...
        function scroll() {
          ...
          _.each(anchors, function (anchor) {
            ...
            var active =
              $section.is(':visible') && top + height - offset >= viewTop && top + offset <= viewTop + viewHeight;
...
Webflow.require('ix').init([
  {
    slug: 'block-modal-wrapper',
    name: 'Block Modal Wrapper',
    value: { style: { display: 'none', opacity: 0 }, triggers: [] },
  },
  {
    slug: 'block-wrapper',
    name: 'Block Wrapper',
    value: { style: { opacity: 0, scaleX: 0.8, scaleY: 0.8, scaleZ: 1 }, triggers: [] },
  },
  {
    slug: 'reservation-button',
    ...
    value: {
      ...
      triggers: [
        {
          type: 'click',
          selector: '.reservation-modal-wrapper',
          preserve3d: true,
          stepsA: [
            { display: 'block' },
            { opacity: 1, transition: 'transform 200 ease 0, opacity 200 ease 0', scaleX: 1, scaleY: 1, scaleZ: 1 },
          ],
          stepsB: [],
        },
        {
          ...
          preserve3d: true,
          stepsA: [
            { opacity: 1, transition: 'opacity 200 ease 0, transform 200 ease 0', scaleX: 1, scaleY: 1, scaleZ: 1 },
          ],
          stepsB: [],
        },
      ],
  ...
  {
    slug: 'reservation-close-button',
    name: 'Reservation Close Button',
    value: {
      style: {},
      triggers: [
        {
          type: 'click',
          selector: '.reservation-modal-wrapper',
          stepsA: [{ opacity: 0, transition: 'transform 200 ease 0, opacity 200 ease 0' }, { display: 'none' }],
          stepsB: [],
        },
        {
          type: 'click',
          ...
          preserve3d: true,
          stepsA: [
            { opacity: 0, transition: 'opacity 200 ease 0, transform 200 ease 0', scaleX: 0.8, scaleY: 0.8, scaleZ: 1 },
          ],
          stepsB: [],
        },
      ],
  ...
  {
    slug: 'review-close-button',
    name: 'Review Close Button',
    value: {
      style: {},
      triggers: [
        {
